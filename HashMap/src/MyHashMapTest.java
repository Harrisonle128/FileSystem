/**
 * This file contains j-unit tests for the MyHashMap.java file.
 */
...
public class MyHashMapTest {
	...
	public void NullTest() {
		testMap.put(TEST_KEY, TEST_VAL);
		testMap.replace(TEST_KEY, "monkey");
		
		testMap.get(TEST_KEY);
		assertEquals("monkey", testMap.get(TEST_KEY));
	}
}